...
<head>
	...
	<link href="<?php echo base_url(); ?>assets/assets/css/authentication/form-2.css" rel="stylesheet" type="text/css" />
		...
		<div class="form-form-wrap">
			<div class="form-container">
				<div class="form-content">
					...
					<h1 class="">CCBA</h1>
					<p class="">Log in to continue.</p>

					<form class="text-left" method="post" action="<?php echo base_url() ?>login">
						<div class="form">
...
<script src="<?php echo base_url(); ?>assets/assets/js/authentication/form-2.js"></script>
